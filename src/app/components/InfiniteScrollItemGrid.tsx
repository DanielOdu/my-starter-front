  ...
  return (
    <>
      <div className=" flex-col w-full relative text-white  py-2 ">
        <div className="text-center"> {totalItems} items found</div>
        <div
          id="test"
          className=" grid grid-cols-[repeat(auto-fit,minmax(150px,1fr))] sm:grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-2 sm:gap-8 py-2
           w-full mb-8 "
        >
          {items?.map((item, idx) => (
            <Card
